...
export class State {
    ...
    public ScanTo(find : string, ignoreCase = false) : string {
        ...
        const ret = this.Text.substring(this.Index, pos - this.Index + 1);
        this.Index = pos;
        return ret;
    }
    ...
    public PeekTo(find : string) : string | null {
        ...
        return this.Text.substring(this.Index, pos - this.Index + 1);
    }
    ...
    public Peek(count : number) : string {
        ...
        return this.Text.substring(this.Index, this.Index + count + 1);
    }
